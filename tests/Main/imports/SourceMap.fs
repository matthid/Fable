...
let [<Import("SourceMapConsumer","source-map")>] SourceMapConsumer: SourceMapConsumerStatic = jsNative
let [<Import("BasicSourceMapConsumer","source-map")>] BasicSourceMapConsumer: BasicSourceMapConsumerStatic = jsNative
let [<Import("IndexedSourceMapConsumer","source-map")>] IndexedSourceMapConsumer: IndexedSourceMapConsumerStatic = jsNative
let [<Import("default","source-map")>] sourceMap: IExports = jsNative

type [<AllowNullLiteral>] IExports =
    abstract SourceMapConsumer: SourceMapConsumerStatic
    abstract BasicSourceMapConsumer: BasicSourceMapConsumerStatic
    abstract IndexedSourceMapConsumer: IndexedSourceMapConsumerStatic
...
type [<AllowNullLiteral>] SourceMapConsumerStatic =
    ...
    [<Emit "new $0($1...)">] abstract Create: rawSourceMap: RawSourceMap * ?sourceMapUrl: SourceMapUrl -> Promise<SourceMapConsumer>
    [<Emit "new $0($1...)">] abstract Create: rawSourceMap: RawIndexMap * ?sourceMapUrl: SourceMapUrl -> Promise<SourceMapConsumer>
    [<Emit "new $0($1...)">] abstract Create: rawSourceMap: U3<RawSourceMap, RawIndexMap, string> * ?sourceMapUrl: SourceMapUrl -> Promise<SourceMapConsumer>
...
type [<AllowNullLiteral>] BasicSourceMapConsumerStatic =
    ...
    [<Emit "new $0($1...)">] abstract Create: rawSourceMap: U2<RawSourceMap, string> -> Promise<BasicSourceMapConsumer>

type [<AllowNullLiteral>] IndexedSourceMapConsumer =
    inherit SourceMapConsumer
    abstract sources: ResizeArray<string> with get, set

type [<AllowNullLiteral>] IndexedSourceMapConsumerStatic =
    abstract prototype: IndexedSourceMapConsumer with get, set
    [<Emit "new $0($1...)">] abstract Create: rawSourceMap: U2<RawIndexMap, string> -> Promise<IndexedSourceMapConsumer>
